        ...
        <div class="md:max-w-[400px] md:gap-14 mx-auto ">
            ...
            <div
                ...
                <div class="flex flex-col items-center justify-center gap-4 h-full md:h-auto">
                    ...
                    <p class="text-xl text-black font-normal">{{ __('email/success.email') }}</p>
                </div>
                <a href="{{ route('view.login') }}"
                    class="uppercase text-white bg-green-600 rounded-md p-4 px-5 w-full max-w-[400px] text-center">{{ __('login/login.log_in') }}</a>
            </div>
        </div>
</x-layout>
