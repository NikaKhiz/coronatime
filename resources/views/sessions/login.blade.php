<x-layout>
    <div class="flex justify-between">
        <div class="w-full">
            <x-navigation />
            <main class="px-4 py-6 md:px-0 md:pl-24 md:py-10 flex justify-between">
                <div>
                    <form action="/login" method="POST" class="flex flex-col gap-6 max-w-[400px]">
                        @csrf
                        <div class="flex flex-col gap-2 md:gap-4">
                            <h1 class="text-black font-bold text-2xl md:text-3xl">Welcome back</h1>
                            <p class="text-gray-600 font-normal text-lg mg:text-2xl ">Welcome back! Please enter your
                                details
                            </p>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="#" class="capitalize font-semibold text-sm text-[#2029F3]">Forgot
                                password?</a>
                        </div>
